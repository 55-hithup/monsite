      ...
      <section className="py-16 md:py-24 bg-[#F8F8F8] border-b border-[#E5E5E5] text-left">
        <div className="container max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <blockquote className="border-l-4 border-[#0284C7] pl-6 py-4 italic text-[#1A1A1A] bg-[#F8FAFC] rounded-none text-lg sm:text-xl font-['Playfair_Display'] leading-relaxed shadow-xs">
              "{t.quote}"
            </blockquote>
