export const caseStudiesData = {
  fr: {
    ...
    locatool: {
      ...
      q1: '1. Quel était le point de départ et le défi rencontré ?',
      a1: 'À l\'origine, LocaTool a été spécialement développé pour répondre aux besoins opérationnels internes de l\'association Le Caf\'Tiers à Saint-Mihiel (Meuse), qui devait gérer et prêter son outillage partagé sans risquer de pertes, de doublons ou de fichiers tableurs éparpillés. Fort du succès sur le terrain, le projet a été étendu et transformé en une véritable plateforme SaaS multi-tenant capable d\'accueillir des loueurs professionnels et entreprises du BTP.',
    ...
    abogame: {
      ...
      q1: '1. Comment est né ce projet d\'animation en direct ?',
      a1: 'AboGame est né d\'une demande sur-mesure d\'un streameur TikTok qui cherchait un outil visuel, fluide et transparent pour sélectionner des spectateurs en direct lors de ses sessions gaming (notamment sur Fortnite). Face à l\'engouement en direct et à la fluidité de la roue, la plateforme a été consolidée puis déployée pour le grand public.',
  ...
  en: {
    ...
    locatool: {
      ...
      q1: '1. What was the origin and initial challenge behind this project?',
      a1: 'LocaTool was originally developed to resolve the internal day-to-day operations of the local community association Le Caf\'Tiers in Saint-Mihiel (Meuse, France), which needed to manage and loan shared tools without losing track of equipment or dealing with messy spreadsheets. Following verified field efficiency, the platform was re-architected and expanded into a scalable multi-tenant SaaS application serving commercial equipment rental providers and construction contractors.',
    ...
    abogame: {
      ...
      q1: '1. How did this live broadcast interactive tool come to life?',
      a1: 'AboGame originated as a bespoke commission requested by a TikTok streamer seeking a transparent, ultra-fast, and visually appealing way to select audience members live during gaming sessions (such as Fortnite). Impressed by the live engagement and real-time responsiveness of the wheel, the platform was fortified and deployed for the general public.',
