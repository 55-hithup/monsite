...
export const servicesCatalog: RawServiceItem[] = [
  ...
  // 3. Applications et logiciels
  {
    ...
    en: {
      ...
      tags: ['iOS & Android', 'React Native', 'App Stores', 'Push Notifications'],
    },
  },
  {
    id: 'apps-android',
  ...
  },
  {
    ...
    en: {
      title: 'iOS Applications (iPhone / iPad)',
      description: 'High-grade iOS applications built according to Apple Human Interface Guidelines and App Store security standards.',
      tags: ['Apple App Store', 'Human Interface', 'iOS Security'],
    },
  },
  {
    ...
    en: {
      ...
      description: 'Unified codebase powering Android, iOS, and Web simultaneously to reduce maintenance overhead and project costs.',
      tags: ['Single Codebase', 'Cost-Effective', 'Rapid Deployment'],
    },
  },
  {
  ...
  },
  {
    ...
    en: {
      ...
      description: 'Deep performance audit and code optimization to achieve 100/100 Google Lighthouse scores and boost rankings.',
  ...
  en: [
    {
      ...
      deliverables: [
        ...
        'Lean architecture & sub-second loading speed (< 500ms)',
    ...
    },
    {
      id: 'ecommerce',
      badge: 'Pillar 02',
      title: 'E-Commerce, Catalogs & Direct Bookings',
      subtitle: 'Online sales, order management, and appointment booking',
      desc: 'Smooth, secure checkout funnels with zero percentage commission on your revenue. Perfect for selling products or taking direct reservations.',
      pricing: 'Custom quote based on your exact requirements',
      deliverables: [
        'Secure card payments via Stripe & PayPal',
        'Intuitive stock, variant, and order management',
        'Bi-directional calendar synchronization & automated alerts',
        'Optimized frictionless checkout workflow',
      ],
      tech: ['Stripe', 'Node.js', 'Firebase', 'Cloud Functions'],
      icon: ShoppingCart,
    },
    {
      ...
      subtitle: 'Custom business software and iOS / Android applications',
      desc: 'Automate internal workflows or launch your digital SaaS product with a blazing-fast custom application accessible anywhere without installation.',
      pricing: 'Custom quote based on indicative €400 / day rate',
      deliverables: [
        'Dynamic real-time dashboards & database management',
        'Encrypted member portals with granular permissions',
        'RESTful API architecture & third-party integrations',
    ...
    },
    {
      id: 'maintenance',
      badge: 'Pillar 04',
      title: 'Maintenance, Performance & Modernization',
      subtitle: 'Technical support, urgent bug fixes, and speed audits',
      desc: 'Trust your web infrastructure speed and security to a dedicated expert. Fast bug fixing and seamless modernization without downtime.',
      pricing: 'One-off intervention or ongoing maintenance plan',
      deliverables: [
        'Comprehensive technical audit & Core Web Vitals optimization',
        'Fixing runtime bugs, security vulnerabilities, and UI issues',
        'Dependency updates and automated cloud backups',
        'Full aesthetic and technical refactor to modern standards',
      ],
...
export const servicesFaqData = {
  ...
  en: [
    ...
    },
    {
      ...
      answer: 'For a One-Page or 3-5 page showcase website, average turnaround is 1 to 3 weeks following scope validation and content receipt. For a web application or SaaS project, a clear milestone schedule is defined in the initial agreement (typically 3 to 6 weeks).',
    },
    {
