...
export default function GlacierContact() {
  ...
  return (
    <section className="glacier-footer-contact-section w-full" id="contact" aria-labelledby="contact-heading">
      <div className="container mx-auto px-6 max-w-6xl">
        <h2 id="contact-heading" className="sr-only">
          Contact et Demande de Devis Personnalisé
        </h2>
        
        {/* 1. Formulaire de Demande de Devis Rapide (En Haut) */}
        <div className="glacier-intake-box mx-auto mb-16 md:mb-20">
        ...
        {/* 2. Coordonnées & Horaires (En Dessous du Formulaire) */}
        <div className="contact-columns-3 max-w-5xl mx-auto pt-8 border-t border-[#E5E5E5]">
